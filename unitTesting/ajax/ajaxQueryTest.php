...
class ajaxQueryTest extends TestCase
{
	...
	public function testInsertProcess()
	{
		...
		$_REQUEST['publish'] = '0';
		$_REQUEST['test_env'] = '';
		$_REQUEST['test_work_dir'] = '';
		$_REQUEST['docker_check'] = 0;
		$_REQUEST['singu_check'] = 0;
		$_REQUEST['docker_img'] = "";
		$_REQUEST['docker_opt'] = "";
		$_REQUEST['singu_img'] = "";
		$_REQUEST['singu_opt'] = "";
		$_REQUEST['script_test'] = "";
		$_REQUEST['script_test_mode'] = "";
		$_REQUEST['run_status'] = "";
		$_REQUEST['run_uuid'] = "";
		$_REQUEST['run_pid'] = "";
		include('ajaxquery.php');
	...
	public function testInsertProfileAmazon()
	{
		...
		$_REQUEST['bash_variable'] = "testAmz";
		$_REQUEST['singu_cache'] = "";
	...
	public function testsaveAllPipeline()
	{
		...
		$_REQUEST['dat'] = '[{"name":"test_pipeline"},{"id":""},{"nodes":{"g-0":[318.6666564941406,106.66666412353516,"1","test_process"]}},{"mainG":[0,0,1]},{"edges":[]},{"summary":""},{"group_id":""},{"write_group_id":""},{"perms":"3"},{"pin":"false"},{"pin_order":""},{"release_date":""},{"script_pipe_header":""},{"script_pipe_config":""},{"script_pipe_footer":"0"},{"script_mode_header":"0"},{"script_mode_footer":"0"},{"pipeline_group_id":"1"},{"process_list":""},{"pipeline_list":""},{"app_list":""},{"publish_web_dir":""},{"publish_dmeta_dir":""},{"pipeline_gid":null},{"rev_comment":""},{"rev_id":0},{"pipeline_uuid":""}]';
		include('ajaxquery.php');
		$this->assertEquals(json_decode($data)->id, '1');
		ob_end_clean();
	}
	...
	public function testsaveAllPipelineUpdate()
	{
		ob_start();
		$_REQUEST['p'] = 'saveAllPipeline';
		$_REQUEST['dat'] = '[{"name":"test_pipeline"},{"id":"1"},{"nodes":{"g-0":[318.6666564941406,106.66666412353516,"1","test_process"]}},{"mainG":[0,0,1]},{"edges":[]},{"summary":"pipeline_summary_updated"},{"group_id":""},{"write_group_id":""},{"perms":"63"},{"pin":"true"},{"pin_order":""},{"release_date":""},{"publicly_searchable":"true"},{"script_pipe_header":""},{"script_pipe_config":""},{"script_pipe_footer":"0"},{"script_mode_header":"0"},{"script_mode_footer":"0"},{"pipeline_group_id":"1"},{"process_list":"1"},{"pipeline_list":"2,3"},{"publish_web_dir":""},{"app_list":""},{"publish_dmeta_dir":""},{"pipeline_gid":null},{"rev_comment":""},{"rev_id":0},{"pipeline_uuid":""}]';
		include('ajaxquery.php');
		$_REQUEST['p'] = 'loadPipeline';
		$_REQUEST['id'] = '1';
		include('ajaxquery.php');
	...
	public function testsaveAllPipeline2()
	{
		...
		$_SESSION['ownerID'] = '2';
		$_REQUEST['p'] = 'saveAllPipeline';
		$_REQUEST['dat'] = '[{"name":"test_pipeline2"},{"id":""},{"nodes":{"g-0":[318.6666564941406,106.66666412353516,"1","test_process"]}},{"mainG":[0,0,1]},{"edges":[]},{"summary":""},{"group_id":""},{"write_group_id":""},{"perms":"3"},{"pin":"false"},{"pin_order":""},{"release_date":""},{"publicly_searchable":"false"},{"script_pipe_config":""},{"script_pipe_header":""},{"script_pipe_footer":"0"},{"script_mode_header":"0"},{"script_mode_footer":"0"},{"pipeline_group_id":"1"},{"process_list":"1,4"},{"pipeline_list":"2,3"},{"publish_web_dir":""},{"app_list":""},{"publish_dmeta_dir":""},{"pipeline_gid":1},{"rev_comment":""},{"rev_id":0},{"pipeline_uuid":""}]';
		include('ajaxquery.php');
		$this->assertEquals(json_decode($data)->id, '2');
		ob_end_clean();
	}
