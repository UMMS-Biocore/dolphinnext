<?php
// load configuration file from DolphinNext
...
$config = [
    ...
    'baseurlpath' => BASE_PATH.'/okta/simplesamlphp/',
 ...
 //   'application' => [
         ...
         */
   //     'baseURL' => 'http://localhost:8080/simplesamlphp/www',
   // ],
    ...
    'technicalcontact_email' => EMAIL_ADMIN,
